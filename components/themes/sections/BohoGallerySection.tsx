...
export default function BohoGallerySection({ invitation }: Props) {
  ...
  return (
    <section className="py-16 px-6" style={{ background: "#faf5ed" }}>
      <Section className="text-center mb-10">
        <p className="text-xs uppercase tracking-[0.3em]" style={{ color: "#d4a853", opacity: 0.7 }}>
          Kenangan
        </p>
        <h2
