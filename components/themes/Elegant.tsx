...
import { elegantConfig } from "@/components/themes/config/elegant";
...
export default function ElegantTheme({ invitation, guestName, wishes }: Props) {
  return (
    <ThemeLayout
      invitation={invitation}
      themeConfig={elegantConfig}
