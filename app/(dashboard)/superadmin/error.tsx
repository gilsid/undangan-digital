  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6" style={{ background: "var(--ink-bg)" }}>
      <div className="ledger-card max-w-sm text-center p-8">
        <p className="font-display text-lg text-[var(--text-primary)] mb-2">Gagal Memuat Halaman</p>
        <p className="text-sm text-[var(--text-secondary)] mb-6">Superadmin panel tidak dapat dimuat.</p>
        <button
          onClick={reset}
